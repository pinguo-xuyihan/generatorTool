...
appTpl.push('<!doctype html>');
appTpl.push('<html lang="">');
appTpl.push(" 	<head>");
appTpl.push(' 		<meta http-equiv="pragma" content="no-cache">');
appTpl.push(' 		<meta http-equiv="Cache-Control " content="no-cache,must-revalidate"> ');
appTpl.push('		<meta name="description" content="">');
appTpl.push('		<meta http-equiv="content-type" content="text/html; charset=UTF-8" />');
appTpl.push('		<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1, maximum-scale=1">');
appTpl.push('		<title>jquerymul</title>');
appTpl.push('		<script src="app/common/lib/mod.js" type="text/javascript"></script>');
appTpl.push('	</head>');
appTpl.push('	<body>');
appTpl.push('		<script type="text/javascript">');
appTpl.push('			var '+ page+'Page = require("jquerymul:app/page/' + page+'/' + page+ '");');
appTpl.push('			'+ page +'Page.render()');
appTpl.push('		</script>');
appTpl.push('	</body>');
appTpl.push('</html>');
